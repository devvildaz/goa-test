...
import (
	...
	productssvr "github.com/devvildaz/goa-code/gen/http/products/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, productsEndpoints *products.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
